  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="crime_report.php">User Home</a></li>
      </ul>
     
      <ul class="nav navbar-nav navbar-right">
        <li ><a href="complaint_report.php">New Complaint</a></li>
        <li class="active"><a href="crime_report.php">New Crime</a></li>
        <li ><a href="complaint_history.php">Complaint History</a></li>
        <li><a href="crime_report_history.php">Crime History</a></li>
...
<div class="video" style="margin-top: 10%"> 
	<div class="center-container">
        ...
        Crime Id 
        <input type="text"  name="crime_id" placeholder="Crime Identity Number" required="" value=<?php #echo "$id_no"; ?>><br>
        Informant Name 
        <input type="text"  name="info_name" placeholder="Informer Names" required="" value=<?php #echo "$id_no"; ?>><br>
        Id Number
