...
if(isset($_POST['s']))
{
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST")
    {
        ...
        $result=mysqli_query($conn,"SELECT Service_No, Id_no FROM userlogin where Service_No='$name' and Id_no='$pass' ");
        ...
        {
          header("location:crime_report.php");
...
?> 
    ...
    <script>
     function f1()
        {
            var sta2=document.getElementById("exampleInputServeNo1").value;
            var sta3=document.getElementById("exampleInputPassword1").value;
          var x2=sta2.indexOf(' ');
var x3=sta3.indexOf(' ');
    if(sta2!="" && x2>=0){
    document.getElementById("exampleInputServeNo1").value="";
    document.getElementById("exampleInputServeNo1").focus();
...
<body style="background-size: cover;
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    ...
    <input type="text" class="form-control" id="exampleInputServeNo1" placeholder="Enter Service No" required name="serv_no" onfocusout="f1()">
     </div>
  <div class="form-group" style="width:30%">
