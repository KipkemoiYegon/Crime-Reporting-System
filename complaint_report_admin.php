  ...
  <div class="container">
    ...
    <div id="navbar" class="collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li ><a href="admin_home.php" style="font-size: 15px;">Admin Home</a></li>
      </ul>
      ...
      <ul class="nav navbar-nav navbar-right">
        ...
        <li class="active"><a href="complaint_report_admin.php" style="font-size: 15px;">New Complaint</a></li>
        <li ><a href="admin_home.php" style="font-size: 15px;">New Crime</a></li>
...
<div class="video" style="margin-top: 10%"> 
	<div class="center-container">
        ...
        Complaint Id 
        <input type="text"  name="complaint_id" placeholder="Crime Identity Number" required="" value=<?php #echo "$id_no"; ?>><br>
        Complainant Name 
        <input type="text"  name="comp_name" placeholder="Informer Names" required="" value=<?php #echo "$id_no"; ?>><br>
        Id Number
        ...
        <input type="text"  name="place" placeholder="Place of the crime" required="" value=<?php #echo "$id_no"; ?>><br>
					...
					<div class="top-w3-agile" style="color: gray">
					Details
						<textarea  name="details" rows="20" cols="50" placeholder="Describe the incident in details with time" onfocusout="f1()" id="desc" required></textarea>
					</div>
